...
function overlay(e){"close"==this.className?enableScroll():disableScroll(),e.preventDefault();var n=this.getAttribute("data-info");el=document.getElementById("overlay"+n),el.style.visibility="visible"==el.style.visibility?"hidden":"visible",el.className="visible"==el.style.visibility?"overlay animated fadeIn":"overlay"}function preventDefault(e){e=e||window.event,e.preventDefault&&e.preventDefault(),e.returnValue=!1}function preventDefaultForScrollKeys(e){return keys[e.keyCode]?(preventDefault(e),!1):void 0}function disableScroll(){window.addEventListener&&window.addEventListener("DOMMouseScroll",preventDefault,!1),window.onwheel=preventDefault,window.onmousewheel=document.onmousewheel=preventDefault,window.ontouchmove=preventDefault,document.onkeydown=preventDefaultForScrollKeys}function enableScroll(){window.removeEventListener&&window.removeEventListener("DOMMouseScroll",preventDefault,!1),window.onmousewheel=document.onmousewheel=null,window.onwheel=null,window.ontouchmove=null,document.onkeydown=null}for(var info=document.getElementsByClassName("info"),close=document.getElementsByClassName("close"),i=0;i<info.length;i++)info[i].addEventListener("click",overlay,!0);for(var i=0;i<close.length;i++)close[i].addEventListener("click",overlay,!0);var keys={37:1,38:1,39:1,40:1};